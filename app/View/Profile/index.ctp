<div class="profiles index">
	...
	<tr>
		...
		<td><?php echo h($profile['Profile']['profile']); ?>&nbsp;</td>
		<td><?php echo h($profile['Profile']['text']); ?>&nbsp;</td>
		<td><?php echo h($profile['Profile']['tgl_buat']); ?>&nbsp;</td>
		<td><?php echo h($profile['Profile']['tgl_ubah']); ?>&nbsp;</td>
		<td class="actions">
